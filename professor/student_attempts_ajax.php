        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-4 text-sm">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-gray-600">Best: <span class="font-semibold text-gray-900"><?= number_format(max($chartScores), 1) ?>%</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
                    <span class="text-gray-600">Latest: <span class="font-semibold text-gray-900"><?= number_format($chartScores[count($chartScores)-1], 1) ?>%</span></span>
                </div>
            </div>
        </div>
